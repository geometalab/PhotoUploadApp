...
class UploadService {
  static const wikimediaAPI = Config.wikimediaApi;
  ...
  Future<http.Response> _sendImage(
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse("$wikimediaAPI?format=json"
            "&action=upload"
            "&filename=$fileName"));
...
""";
    ...
    Future<http.Response> response = http.post(
        Uri.parse('$wikimediaAPI?action=edit&format=json'),
  ...
  checkCsrfToken(String token) async {
    Future<http.Response> response = http.post(
        Uri.parse('$wikimediaAPI?action=checktoken&type=csrf&format=json'),
        headers: <String, String>{
          'Content-Type': 'application/x-www-form-urlencoded ',
          'Authorization': 'Bearer ${await getAccessToken()}',
        },
  ...
  Future<Map> getCsrfToken() async {
    ...
    Future<http.Response> response = http.get(
      Uri.parse('$wikimediaAPI?action=query&meta=tokens&format=json'),
      headers: <String, String>{
        'Authorization': 'Bearer ${await getAccessToken()}',
      },
    );
